...
import AboutWithoutTitle from "../about/AboutWithoutTitle";
    ...
    <>
      {isDesktopOrLaptop ? (
        <div className="relative ">
          ...
          <div className="w-full h-full px-24 mt-56 text-white py-14 md:px-12 bg-MetallicBlue">
            <div className="flex px-6 pt-6 mx-6 ">
              <div className=" w-[40%] md:w-[45%]  h-[60%] mt-10 mr-16 md:mr-3 ">
                ...
                <p className="text-base text-justify text-white/70 font-poppins">
                {t("principles-text")}
                </p>
                {/* <p className="pt-4 text-base text-justify text-white/70 font-poppins">
                  National Id shall mean foundational Digital ID. From this
                  Program's perspective , the term.
                </p> */}
            ...
            {/* <div className="flex px-10 pt-10 mx-5 mr-10 border-2 pb-14 border-white/20 rounded-2xl ">
              <div className="w-[90%]">
                <h1 className="mb-6 text-6xl font-light text-white font-barlow">
                  <span className="font-medium text-green">NID</span> Ecosystem
                </h1>

                <div className="flex justify-center items-center gap-10 mb-6 w-[90%]">
                  <img
                    src={regIcon}
                    className="w-16 h-auto mt-6 border-2 rounded-full border-green"
                    alt="Icon_checklist"
                  />
                  <div className="mt-4">
                    <h2 className="text-2xl font-semibold text-white font-barlow">
                      Registration
                    </h2>
                    <p className="mt-2 text-sm text-justify text-white/70 font-poppins">
                      {" "}
                      This stage require physical apperance of the applicant of
                      at registration s tation. All inputs and bitation. All
                      inputs and bitation. All inputs and biometric data will be
                      taken
                    </p>
                  </div>
                </div>
                <div className="flex justify-center items-center gap-10 mb-6 w-[90%]">
                  <img
                    src={callIcon}
                    className="w-auto h-16 p-2 mt-6 border-2 rounded-full border-green"
                    alt="Icon_checklist"
                  />
                  <div className="mt-4">
                    <h2 className="text-2xl font-semibold text-white font-barlow">
              ...
              <div className="  w-[90%]">
                <div className="flex justify-center items-center gap-10 mb-6 w-[100%]">
                  <img
                    src={preRegIcon}
                    className="w-16 p-2 mt-6 border-2 rounded-full border-green"
                    alt="Icon_checklist"
                  />
                  <div className="mt-4">
                    <h2 className="text-2xl font-semibold text-white font-barlow">
                ...
                <div className="flex items-center gap-10 mb-6 w-[100%]">
                  <img
                    src={credIcon}
                    className="w-16 h-16 p-2 mt-6 border-2 rounded-full border-green"
                    alt="Icon_checklist"
                  />
                  <div className="mt-4">
                    <h2 className="text-2xl font-semibold text-white font-barlow">
                    ...
                    <p className="mt-2 text-sm text-justify text-white/70 font-poppins">
                      ...
                      ID(Fayda) number prepares credentials for each registered
                      individual prepares credentials for each registered
                      individual prepares credentials for each registered
                      individual prepares credentials for each registered
                      individual
                    </p>
